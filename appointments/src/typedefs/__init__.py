...
class RootT(Enum):
    SUCHMANN_APPOINTMENTS_ROOT = "suchmann.appointments.root"
    @classmethod
...
class AppointmentT(Enum):
    SUCHMANN_APPOINTMENTS_APPOINTMENT = "suchmann.appointments.appointment"
    @classmethod
    def from_json_data(cls, data: Any) -> 'AppointmentT':
        return cls(data)
...
class Appointment:
    ...
    @classmethod
    def from_json_data(cls, data: Any) -> 'Appointment':
        return cls(
            _from_json_data(str, data.get("date")),
            _from_json_data(str, data.get("end")),
            _from_json_data(str, data.get("start")),
            _from_json_data(AppointmentT, data.get("t")),
            _from_json_data(str, data.get("tag")),
    ...
    def to_json_data(self) -> Any:
        ...
        data["t"] = _to_json_data(self.t)
        data["tag"] = _to_json_data(self.tag)
        data["title"] = _to_json_data(self.title)
        return data

class CategoryT(Enum):
    SUCHMANN_APPOINTMENTS_CATEGORY = "suchmann.appointments.category"
    @classmethod
...
class Category:
    ...
    def from_json_data(cls, data: Any) -> 'Category':
        return cls(
            _from_json_data(List[Appointment], data.get("items")),
